...
IF (HYDRA_FOUND)
	SET(HYDRA_LIBRARIES_DIR ${INTHADDIR}/lib )
	SET(HYDRA_INCLUDE_DIR ${INTHADDIR}/include )

	SET(HYDRA_LIBRARIES "")

	# Make variables changeble to the advanced user
	MARK_AS_ADVANCED( HYDRA_LIBRARIES_DIR HYDRA_INCLUDE_DIR HYDRA_DEFINITIONS)

	# Set HYDRA_INCLUDES
	SET(HYDRA_INCLUDES ${HYDRA_INCLUDE_DIR})

	SET(LD_LIBRARY_PATH ${LD_LIBRARY_PATH} ${HYDRA_LIBRARIES_DIR})
ENDIF (HYDRA_FOUND)
